...
# Add the azure-policy add-on on the AKS cluster
az aks enable-addons --addons azure-policy --name myAks-cluster -g myAks

# Showcase the pods in the ns gatekeeper-system
kubectl get pods -n gatekeeper-system
echo "azure-policy pods are in the kube-system namespace"